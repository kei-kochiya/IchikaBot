...
class NowPlayingView(discord.ui.View):
    ...
    @discord.ui.button(label="⏸ Pause", style=discord.ButtonStyle.secondary, custom_id="np:pause", row=0)
    ...
    @discord.ui.button(label="⏭ Skip", style=discord.ButtonStyle.primary, custom_id="np:skip", row=0)
    ...
    @discord.ui.button(label="🔁 Loop", style=discord.ButtonStyle.secondary, custom_id="np:loop", row=0)
    ...
    @discord.ui.button(label="🔀 Shuffle", style=discord.ButtonStyle.secondary, custom_id="np:shuffle", row=0)
